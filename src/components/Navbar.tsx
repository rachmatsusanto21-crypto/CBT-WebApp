...
import { ShieldAlert, BookOpen, GraduationCap, Users, Sparkles, Printer, FileCode2, BarChart2, Archive, UserCheck, Key, Cloud } from 'lucide-react';

interface NavbarProps {
  currentMode: 'siswa' | 'admin';
  setMode: (mode: 'siswa' | 'admin') => void;
  adminTab: 'monitoring' | 'bank-soal' | 'riwayat-soal' | 'data-siswa' | 'cetak' | 'rekap' | 'gas' | 'settings' | 'gdrive';
  setAdminTab: (tab: 'monitoring' | 'bank-soal' | 'riwayat-soal' | 'data-siswa' | 'cetak' | 'rekap' | 'gas' | 'settings' | 'gdrive') => void;
  schoolName: string;
